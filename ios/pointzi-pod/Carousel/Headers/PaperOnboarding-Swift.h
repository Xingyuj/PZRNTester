...
SWIFT_MODULE_NAMESPACE_PUSH("PaperOnboarding")
@class UIImageView;
@class UILabel;
@class NSCoder;
...
@property (nonatomic, copy) NSString * _Nullable imageSource;
...
SWIFT_CLASS("_TtC15PaperOnboarding18OnboardingItemInfo")
@interface OnboardingItemInfo : NSObject
@property (nonatomic, strong) UIImage * _Nullable shImage;
@property (nonatomic, copy) NSString * _Nullable shImageSource;
@property (nonatomic, copy) NSString * _Nullable shTitle;
@property (nonatomic, copy) NSString * _Nullable shDesc;
@property (nonatomic, strong) UIImage * _Nullable shIcon;
@property (nonatomic, copy) NSString * _Nullable shIconSource;
@property (nonatomic, strong) UIColor * _Nullable shColor;
@property (nonatomic, strong) UIColor * _Nullable shTitleColor;
@property (nonatomic, strong) UIColor * _Nullable shDescriptionColor;
@property (nonatomic, strong) UIFont * _Nullable shTitleFont;
@property (nonatomic, strong) UIFont * _Nullable shDescriptionFont;
...
@interface PaperOnboarding (SWIFT_EXTENSION(PaperOnboarding))
...
SWIFT_PROTOCOL("_TtP15PaperOnboarding25PaperOnboardingDataSource_")
@protocol PaperOnboardingDataSource
/// Asks the data source to return the number of items.
/// \param index An index of item in PaperOnboarding.
///
///
/// returns:
...
SWIFT_PROTOCOL("_TtP15PaperOnboarding23PaperOnboardingDelegate_")
@protocol PaperOnboardingDelegate
/// Tells the delegate that the paperOnbording start scrolling.
/// \param index An curretn index item
///
...
/// \param item A OnboardingContentViewItem object that PaperOnboarding is going to use when drawing the row.
///
/// \param index An curretn index item
///
